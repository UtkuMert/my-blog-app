...
public class PostController {
	...
	@GetMapping
	public List<PostResponse> getAllPosts(@RequestParam Optional<Long> userId,@RequestParam Optional<String> cat){
		return postService.getAllPostsWithParam(userId,cat);
	}
